...
// DETAILS: based on houghGPUv3.cu, but replacing sin(), cos() call with sincos()
// but seems like sincos() is slower than calling sin() and cos() separately.
// time on Car.png is 9397013874 ns
